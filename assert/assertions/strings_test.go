...
func (this *AssertionsFixture) TestShouldStartWith() {
	...
	this.fail(so("", ShouldStartWith, "x"), "Expected '' to start with 'x' (but it didn't)!")
	this.pass(so("abc", ShouldStartWith, "abc"))
	this.fail(so("abc", ShouldStartWith, "abcd"), "Expected 'abc' to start with 'abcd' (but it didn't)!")

	this.pass(so("superman", ShouldStartWith, "super"))
	this.fail(so("superman", ShouldStartWith, "bat"), "Expected 'superman' to start with 'bat' (but it didn't)!")
	this.fail(so("superman", ShouldStartWith, "man"), "Expected 'superman' to start with 'man' (but it didn't)!")
...
func (this *AssertionsFixture) TestShouldEndWith() {
	...
	this.fail(so("", ShouldEndWith, "z"), "Expected '' to end with 'z' (but it didn't)!")
	this.pass(so("xyz", ShouldEndWith, "xyz"))
	this.fail(so("xyz", ShouldEndWith, "wxyz"), "Expected 'xyz' to end with 'wxyz' (but it didn't)!")

	this.pass(so("superman", ShouldEndWith, "man"))
	this.fail(so("superman", ShouldEndWith, "super"), "Expected 'superman' to end with 'super' (but it didn't)!")
	this.fail(so("superman", ShouldEndWith, "blah"), "Expected 'superman' to end with 'blah' (but it didn't)!")
...
func (this *AssertionsFixture) TestShouldContainSubstring() {
	...
	this.fail(so("qwer", ShouldContainSubstring, "sd"), "Expected 'qwer' to contain substring 'sd' (but it didn't)!")
}
...
func (this *AssertionsFixture) TestShouldBeBlank() {
	...
	this.fail(so("asdf", ShouldBeBlank), "Expected 'asdf' to be blank (but it wasn't)!")
