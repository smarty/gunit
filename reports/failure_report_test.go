...
func TestFailureReport(t *testing.T) {
	actual := FailureReport("Failure", exampleStackFrames)
...
(0): this.assertScore(0) // bowling_game_test.go:24
Failure`)
...
var exampleStackFrames = []Frame{
	...
	{Line: 24, Function: "github.com/smartystreets/gunit/advanced_examples.(*BowlingGameScoringFixture).TestAfterAllGutterBallsTheScoreShouldBeZero", File: "/Users/mike/src/github.com/smartystreets/gunit/advanced_examples/bowling_game_test.go"},
